...
module "ff-proxy-ecs" {
  ...
  proxy_subnets = data.aws_subnets.private.ids
...
| <a name="input_cluster_name"></a> [cluster\_name](#input\_cluster\_name) | Name for the ECS cluster created by the module (if no existing cluster id given) | `string` | `""` | no |
...
| <a name="input_image"></a> [image](#input\_image) | proxy image to use, eg: harness/ff-proxy:2.0.0-rc24 | `string` | n/a | yes |
...
| <a name="input_proxy_security_groups"></a> [proxy\_security\_groups](#input\_proxy\_security\_groups) | VPC security groups to attach to the proxy tasks | `list(string)` | `[]` | no |
...
| <a name="input_redis_security_groups"></a> [redis\_security\_groups](#input\_redis\_security\_groups) | VPC security groups to attach to the redis instance | `list(string)` | `[]` | no |
